...
let reawEmbed = new Discord.MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Developed By mithra", message.guild.iconURL({dynamic: true})).setColor("RANDOM")
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["spotyengel", "spotyengel","spoengel"],
    permLevel: 0,
  }
