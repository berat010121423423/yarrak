...
exports.run = async(client, message, args, ayar, emoji) => {
  ...
  if (!message.member.hasPermission("VIEV_AUDIT_LOG")) return message.channel.send(embed.setDescription("<a:croz:806650760104247327> **Bu Komutu Kullanabilmek İçin Yetkin Bulunmuyor.**")).then(x => x.delete({timeout: 5000}));
